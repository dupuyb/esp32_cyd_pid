...
void lv_create_main_gui(void) {
  ...
  lv_label_set_text(label_pwm, "Flux :");
  ...
  lv_obj_set_pos(g_label_pwm_value, 64, lower_row_2_y);
  ...
  lv_obj_set_pos(label_pwm_unit, 88, lower_row_2_y);

  g_led_pwm_state = lv_obj_create(panel_vmc);
  lv_obj_set_size(g_led_pwm_state, 28, 28);
  lv_obj_set_pos(g_led_pwm_state, 110, (lower_row_1_y + lower_row_2_y) / 2 - 6);
