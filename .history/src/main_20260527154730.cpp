...
static void refresh_external_html_tools() {
  ...
  frame.externalHtmlTools =
    "<div class='action-item'><div>- Temperatures</div><div class='button-group'>"
    "<span class='button'>Current: " + current_temp_text + " C</span>"
    "<span class='button'>Setpoint: " + setpoint_temp_text + " C</span>"
    "</div></div>"
    "<div class='action-item'><div>- V.M.C. Status</div><div class='button-group'>"
    "<span class='button'>State: " + vmc_state_text + "</span>"
    "<span class='button'>Speed: " + pwm_text + "%</span>"
    "</div></div>"
