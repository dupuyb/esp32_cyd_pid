...
extern lv_obj_t * g_ctx_kp_minus;
extern lv_obj_t * g_ctx_kp_plus;
extern lv_obj_t * g_ctx_ki_minus;
extern lv_obj_t * g_ctx_ki_plus;
extern lv_obj_t * g_ctx_kd_minus;
extern lv_obj_t * g_ctx_kd_plus;  
