...
#define PWM_ACTIVE_STATE_PIN 35 // ATTENTION 35 IN ONLY
...
static void set_pwm_percent(float percent) {
  ...
  digitalWrite(PWM_ACTIVE_STATE_PIN, (duty > 0U) ? HIGH : LOW);
...
void setup() {
  ...
  pinMode(PWM_ACTIVE_STATE_PIN, OUTPUT);
  digitalWrite(PWM_ACTIVE_STATE_PIN, LOW);
  set_pwm_percent(0.0f);
