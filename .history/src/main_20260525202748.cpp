...
static void create_pid_adjuster(
  ...
  *value_label = lv_label_create(parent);
  ...
  lv_obj_set_pos(*value_label, 58, y + 4);
  update_pid_value_label(*value_label, *value);

  lv_obj_t * btn_minus = lv_button_create(parent);
  lv_obj_set_size(btn_minus, 22, 20);
  lv_obj_set_pos(btn_minus, 90, y);
  lv_obj_t * lbl_minus = lv_label_create(btn_minus);
  lv_label_set_text(lbl_minus, "-");
  lv_obj_center(lbl_minus);

  lv_obj_t * btn_plus = lv_button_create(parent);
  lv_obj_set_size(btn_plus, 22, 20);
  lv_obj_set_pos(btn_plus, 112, y);
...
void lv_create_main_gui(void) {
  ...
  lv_obj_set_size(panel_temp, half_w, half_h);
  ...
  create_pid_adjuster(panel_pid, 28, "Prop.", &g_label_kp_value, &g_kp, 0.010f, 0.000f, 25.000f, &g_ctx_kp_minus, &g_ctx_kp_plus, "Kp");
  create_pid_adjuster(panel_pid, 50, "Integ.", &g_label_ki_value, &g_ki, 0.050f, 0.000f, 50.000f, &g_ctx_ki_minus, &g_ctx_ki_plus, "Ki");
  create_pid_adjuster(panel_pid, 72, "Deriv.", &g_label_kd_value, &g_kd, 0.050f, 0.000f, 50.000f, &g_ctx_kd_minus, &g_ctx_kd_plus, "Kd");
  ...
  lv_label_set_text(label_rpm, "Cmd %:");
  lv_obj_set_pos(label_rpm, 8, 64);
  ...
  lv_obj_set_pos(g_label_pwm_value, 70, 64);
  ...
  lv_obj_set_pos(g_label_vmc_state, 66, 34);

  lv_obj_t * panel_status = lv_obj_create(screen);
  lv_obj_set_pos(panel_status, half_w, half_h);
  lv_obj_set_size(panel_status, screen_w - half_w, screen_h - half_h);
  ...
  lv_obj_set_pos(separator_h, 0, half_h);
