...
static void control_slider_event_callback(lv_event_t * e) {
  ...
  lv_obj_set_style_text_color(g_label_control_value, color_from_temperature(control_temp_tenth / 10.0f), 0);
...
void lv_create_main_gui(void) {
  ...
  lv_obj_set_size(panel_temp, 168, 112);
  ...
  lv_obj_set_pos(g_label_reading_value, 74, 38);
  ...
  lv_obj_set_pos(label_humidity, 10, 82);
  ...
  create_pid_adjuster(panel_pid, 32, "Prop.", &g_label_kp_value, &g_kp, 0.010f, 0.000f, 25.000f, &g_ctx_kp_minus, &g_ctx_kp_plus, "Kp");
  create_pid_adjuster(panel_pid, 54, "Integ.", &g_label_ki_value, &g_ki, 0.050f, 0.000f, 50.000f, &g_ctx_ki_minus, &g_ctx_ki_plus, "Ki");
  create_pid_adjuster(panel_pid, 76, "Deriv.", &g_label_kd_value, &g_kd, 0.050f, 0.000f, 50.000f, &g_ctx_kd_minus, &g_ctx_kd_plus, "Kd");
