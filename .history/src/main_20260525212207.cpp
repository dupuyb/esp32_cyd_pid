...
void lv_create_main_gui(void) {
  ...
  lv_obj_align(title_pid, LV_ALIGN_TOP_MID, 0, 6);

  int pid_bottom_line_y = top_h - 30;

  // switch PID
  lv_obj_t * switch_pid = lv_switch_create(panel_pid);
  lv_obj_set_pos(switch_pid, panel_pid_w - 58, pid_bottom_line_y);
  ...
  create_pid_adjuster(panel_pid, 32, "Pro.", &g_label_kp_value, &g_kp, 0.010f, 0.000f, 25.000f, &g_ctx_kp_minus, &g_ctx_kp_plus, "Kp");
  create_pid_adjuster(panel_pid, 56, "Int.", &g_label_ki_value, &g_ki, 0.050f, 0.000f, 50.000f, &g_ctx_ki_minus, &g_ctx_ki_plus, "Ki");
  create_pid_adjuster(panel_pid, 80, "Dev.", &g_label_kd_value, &g_kd, 0.050f, 0.000f, 50.000f, &g_ctx_kd_minus, &g_ctx_kd_plus, "Kd");
  ...
  lv_obj_set_pos(g_label_pid_state, 8, pid_bottom_line_y + 4);
  ...
  lv_obj_align(label_vmc, LV_ALIGN_TOP_MID, 0, 6);
  ...
  lv_obj_set_pos(label_rpm, 8, lower_row_2_y);
  ...
  lv_obj_set_pos(g_label_pwm_value, 70, lower_row_2_y);
  ...
  lv_obj_set_pos(g_label_vmc_state, 66, lower_row_1_y + 4);
  ...
  lv_obj_align(label_access, LV_ALIGN_TOP_MID, 0, 6);
